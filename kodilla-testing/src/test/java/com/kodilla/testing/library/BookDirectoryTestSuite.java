...
public class BookDirectoryTestSuite {
    ...
    @Test
    public void testListBooksInHandsOf0borrowedBooks() {
        // Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        List<Book> resultListOf0Books = new ArrayList<Book>();
        LibraryUser libraryUser = new LibraryUser("John", "Smith", "90123101234");
    ...
    @Test
    public void testListBooksInHandsOf1borrowedBook() {
        // Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        ...
        // When
        List<Book> theListOfBook1 = bookLibrary.listBooksInHandsOf(libraryUser);
    ...
    @Test
    public void testListBooksInHandsOf5BorrowedBooks() {
        //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
